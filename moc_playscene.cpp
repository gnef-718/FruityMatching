...
QT_MOC_LITERAL(1, 10, 4), // "home"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 4), // "back"
QT_MOC_LITERAL(4, 21, 9), // "musicstop"
QT_MOC_LITERAL(5, 31, 9), // "musicplay"
QT_MOC_LITERAL(6, 41, 13) // "reshuffletrue"

    },
    "PlayScene\0home\0\0back\0musicstop\0musicplay\0"
    "reshuffletrue"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->musicstop(); break;
        case 3: _t->musicplay(); break;
        case 4: _t->reshuffletrue(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::home)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PlayScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::back)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PlayScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::musicstop)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (PlayScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::musicplay)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (PlayScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::reshuffletrue)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 2
void PlayScene::musicstop()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void PlayScene::musicplay()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void PlayScene::reshuffletrue()
{
